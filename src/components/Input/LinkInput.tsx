  ...
  return (
    <div className="relative ml-0 flex flex-col md:ml-10">
      <div className="flex-start mb-15 flex">
        <Controller
          ...
          render={({ field }) => (
            <Input
              ...
              style={
                saveIconClicked
                  ? 'xs-input mr-20 save-input md:mr-10 md:placeholder:text-12'
                  : 'xs-input mr-20 md:mr-10 md:placeholder:text-12'
              }
        ...
        <Controller
          ...
          render={({ field }) => (
            <Input
              ...
              style={
                saveIconClicked
                  ? 'lg-input mr-10 save-input md:placeholder:text-12'
                  : 'lg-input mr-10 md:placeholder:text-12'
              }
              readOnly={saveIconClicked}
              onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        />
        <div className="flex-center w-60 md:ml-5 md:w-40">
          {isEditing ? (
